...
def parse_args():
    parser = argparse.ArgumentParser(description="Preprocess raw Chinese text into clean sentences.")
    parser.add_argument("--input", type=str, default=str(INPUT_PATH), help="Raw text file path")
    parser.add_argument("--output", type=str, default=str(OUTPUT_PATH), help="Output sentences path")
