...
NOISE_PATTERNS = [
    ...
    re.compile(r"^问："),
    re.compile(r"^答："),
    # 新增：小节标题、图片说明、新华社发等噪声
    re.compile(r"^（[一二三四五六七八九十]+）"),   # 小节标题
    re.compile(r"^图片$"),                       # 单独“图片”
    re.compile(r"新华社发"),                     # 新华社发
    re.compile(r"摄）$"),                        # 以“摄）”结尾
    re.compile(r"^这是\d{4}年.*拍摄的"),         # “这是xxxx年...拍摄的”
]
